[project]/src/data/universeRegistry.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getUniverseData(id) {
    ...
    if (id === 'got') {
        ...
        accentColor = '#3b82f6';
        backdrop = '/Images/cosmic_nebula.png';
        ...
        accentColor = '#ea580c';
        backdrop = '/Images/fellowship_mountain.png';
