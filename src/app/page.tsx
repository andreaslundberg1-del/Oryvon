  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content wrapper */}
        <div className="w-full py-2 md:py-3 pb-12 md:pb-16 flex flex-col justify-between items-center relative z-30">
          {selectedGenre && activeGenreInfo ? (
            ...
            <div className="flex flex-col items-center w-full pt-12 p-4 md:p-8 gap-6 md:gap-8 pb-32">
              {/* Top Navigation Bar */}
              <div className="w-full max-w-[1720px] px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6 border-b border-white/10 pb-6">
                <div className="flex flex-col items-center md:items-start gap-1">
                  ...
                  <h2
                    className="text-xl md:text-2xl lg:text-3xl font-normal tracking-[0.2em] text-white uppercase"
                ...
                <div className="flex items-center gap-4 md:gap-6">
                  <OryndorLogo size={120} variant="horizontal" />
                  <button
              ...
              {featuredSlides.length > 0 && (
                <div className="carousel-container w-full max-w-[1720px] px-4 md:px-8 relative rounded-xl overflow-hidden mb-4 animate-fade-in">
                  <div
                    className="relative w-full rounded-xl overflow-hidden border border-white/10 aspect-[21/9] md:aspect-[16/9] lg:aspect-[21/9] min-h-[300px] md:min-h-[360px] lg:min-h-[460px] bg-cover bg-center transition-all duration-1000 ease-in-out"
                    style={{
                  ...
                  >
                    ...
                    <div className="absolute left-4 md:left-8 lg:left-16 bottom-6 md:bottom-8 lg:bottom-12 z-20 max-w-xl md:max-w-2xl flex flex-col gap-2 md:gap-3 lg:gap-4 px-4">
                      ...
                      <h1
                        className="text-2xl md:text-3xl lg:text-5xl xl:text-6xl font-normal tracking-[0.15em] text-white leading-tight"
                        style={{
                      ...
                      <p className="text-white/70 text-[10px] md:text-xs lg:text-sm font-sans leading-relaxed tracking-wide mt-1 md:mt-2 line-clamp-2 md:line-clamp-3">
              ...
              <div className="w-full max-w-[1720px] px-4 md:px-8 flex flex-col lg:flex-row gap-4 md:gap-6 justify-between items-center py-3 md:py-4 mb-3 md:mb-4 bg-white/[0.02] border border-white/5 rounded-xl p-4 md:p-6 backdrop-blur-md">
                {/* Search Bar */}
              ...
              {filteredUniverses.length === 0 ? (
                ...
                <div className="w-full max-w-[1720px] px-4 md:px-8 flex flex-col gap-12">
                  {filteredUniverses.length === 0 ? (
                    <div className="w-full text-center py-20 flex flex-col items-center gap-4">
                      <Compass size={60} color={activeGenreInfo.color} pulse />
                      <span className="font-mono text-[10px] text-white/30 tracking-[0.4em] uppercase">
