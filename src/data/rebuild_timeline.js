...
const milestones = {
  1950: { img: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2070', ambience: 'radar', scroll: 'clunky' },
  1958: { 
    img: 'https://images.unsplash.com/photo-1552820728-8b83bb6b773f?q=80&w=2070', 
    ambience: 'radar', 
    scroll: 'clunky',
    events: [
      { type: 'text-write', data: { text: 'TERMINAL LINK ESTABLISHED...' } },
      { type: 'glitch', data: { intensity: 0.5 } }
    ],
    narrative: {
      quote: { en: "A display connected to a digital computer gives us a chance to gain familiarity with concepts not realizable in the physical world.", sv: "En bildskärm ansluten till en digital dator ger oss en chans att bekanta oss med koncept som inte går att förverkliga i den fysiska världen." },
      author: "Ivan Sutherland (1965)"
    }
  },
  1962: { img: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2070', ambience: 'radar', scroll: 'clunky' },
  1972: { img: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2070', ambience: 'synthwave', scroll: 'normal' },
  1980: { img: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=2071', ambience: 'synthwave', scroll: 'normal' },
  1985: { 
    img: 'https://images.unsplash.com/photo-1612404730960-5c71577fca11?q=80&w=2070', 
    ambience: 'synthwave', 
    scroll: 'normal',
    events: [
      { type: 'glitch', data: { duration: 2 } },
      { type: 'morph', data: { from: 'pixels', to: 'sprites' } }
    ],
    narrative: {
      quote: { en: "The Amiga is so far ahead of its time that almost nobody could fully understand it.", sv: "Amigan är så långt före sin tid att nästan ingen kunde förstå den helt." },
      author: "Jay Miner"
    }
  },
  1993: { 
    ...
    scroll: 'smooth',
    events: [
      { type: 'doom-climax', data: { intensity: 'high' } }
    ],
    narrative: {
      quote: { en: "The speed of light is too slow.", sv: "Ljusets hastighet är för långsam." },
      author: "John Carmack"
    }
  },
  1995: { 
    img: 'https://images.unsplash.com/photo-1605901309584-818e25960b8f?q=80&w=2119', 
    ambience: 'orchestral', 
    scroll: 'smooth',
    events: [
      { type: 'toy-story-render', data: { character: 'woody' } }
    ]
  },
  2007: { 
    img: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070', 
    ...
    scroll: 'smooth',
    events: [
      { type: 'image-reveal', data: { effect: 'bloom' } }
    ]
  },
  2018: { 
    img: 'https://images.unsplash.com/photo-1612404730960-5c71577fca11?q=80&w=2070', 
    ...
    scroll: 'hyper',
    events: [
      { type: 'rtx-on', data: { reflections: true } }
    ]
  },
  2024: { img: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070', ambience: 'future', scroll: 'hyper' },
  2026: { img: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070', ambience: 'future', scroll: 'hyper' }
};
...
const data = [
  ...
  { year: 1999, style: 'cyber', colors: { p: '#00ff00', b: '#050505' }, desc: 'Dreamcast/Y2K-design. Glossy futuristiska menyer and tidig online-estetik.' },
...
function generate(y) {
  const meta = milestones[y.year] || {};
  const images = [];
  if (meta.img) {
    images.push({ url: meta.img, alt: `Visual of ${y.year}` });
  }

  // Determine ambience based on year if not specified
  let ambience = meta.ambience;
  if (!ambience) {
    if (y.year < 1970) ambience = 'radar';
    else if (y.year < 1990) ambience = 'synthwave';
    else if (y.year < 2010) ambience = 'orchestral';
    else ambience = 'modern';
  }

  // Determine scrollFeel based on year if not specified
  let scroll = meta.scroll;
  if (!scroll) {
    if (y.year < 1970) scroll = 'clunky';
    else if (y.year < 1995) scroll = 'normal';
    else if (y.year < 2015) scroll = 'smooth';
    else scroll = 'hyper';
  }
  ...
  return {
    ...
    tech: {
      title: { en: 'Technological Leaps', sv: 'Tekniska Språng', ja: '技術적飛躍' },
      hardware: [],
...
const output = `import { Timeline } from '@/types/timeline';

export const graphicsTimeline: Timeline = {
  id: 'graphics-history',
  title: {
    en: 'The History of Graphics',
    sv: 'Grafikens Historia',
    ja: 'グラフィックスの歴史'
  },
  description: {
    en: 'A visual journey from the first pixels to ray-traced reality.',
    sv: 'En visuell resa från de första pixlarna till strålspårad verklighet.',
    ja: '最初のピクセルからレイトレーシングによる現実まで、視覚的な旅を。'
  },
  years: ${JSON.stringify(data.map(generate), null, 2)}
};
`;

fs.writeFileSync('src/data/graphicsTimeline.ts', output, 'utf8');
