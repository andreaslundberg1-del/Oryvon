    ...
    <div className="space-y-6">
      ...
      <div className="bg-black/30 border border-white/10 rounded-xl p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-mono uppercase tracking-widest text-white/80">Hero Content</h3>
        </div>
      ...
      <div className="bg-black/30 border border-white/10 rounded-xl p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-mono uppercase tracking-widest text-white/80">Logo & Symbol</h3>
        </div>
